...
export namespace Flag {
  ...
  export const OPENCODE_EXPERIMENTAL_AGENT_TEAMS = truthy("OPENCODE_EXPERIMENTAL_AGENT_TEAMS")

  export async function agentTeams() {
    if (OPENCODE_EXPERIMENTAL_AGENT_TEAMS) return true
