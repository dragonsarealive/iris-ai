...
import { Binary } from "@iris-ai/util/binary"
...
import type { Path } from "@iris-ai/sdk"
import type { Workspace } from "@iris-ai/sdk/v2"
import type { TeamInfo, TeamMemberInfo, TeamMessageInfo, TaskItemInfo } from "@/team/event"

export type OrchestrationStepInfo = {
  id: string
  teamID: string
  time: number
...
export const { use: useSync, provider: SyncProvider } = createSimpleContext({
  ...
  init: () => {
    const [store, setStore] = createStore<{
      ...
      team: { [teamID: string]: TeamInfo }
      team_member: { [teamID: string]: TeamMemberInfo[] }
      team_message: { [sessionID: string]: TeamMessageInfo[] }
      task_item: { [teamID: string]: TaskItemInfo[] }
      orchestration_steps: { [teamID: string]: OrchestrationStepInfo[] }
    }>({
      provider_next: {
        all: [],
        default: {},
