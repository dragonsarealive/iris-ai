...
export const UninstallCommand = {
  command: "uninstall",
  describe: "uninstall IRIS and remove related files (npm global name may be iris or opencode-ai)",
  builder: (yargs: Argv) =>
    yargs
      .option("keep-config", {
        alias: "c",
...
async function executeUninstall(method: Installation.Method, targets: RemovalTargets) {
  ...
  UI.empty()
  prompts.log.success("Thank you for using IRIS!")
}
