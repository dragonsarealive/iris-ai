  ...
  new Hono()
    .get(
      ...
      describeRoute({
        ...
        description: "Get a list of all IRIS sessions, sorted by most recently updated.",
    ...
    .get(
      ...
      describeRoute({
        summary: "Get session",
        description: "Retrieve detailed information about a specific IRIS session.",
        tags: ["Session"],
    ...
    .post(
      ...
      describeRoute({
        ...
        description: "Create a new IRIS session for interacting with AI assistants and managing conversations.",
