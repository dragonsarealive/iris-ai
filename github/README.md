   ...
   jobs:
     opencode:
       ...
       steps:
          ...
          - name: Run opencode
           uses: dragonsarealive/iris-ai/github@latest
           env:
...
This is an early release. If you encounter issues or have feedback, please create an issue at https://github.com/dragonsarealive/iris-ai/issues.
